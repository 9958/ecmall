...
/* 当前ECMall程序Release */
define('RELEASE', '20170906');

/*  开启全局的Cookie的HttpOnly属性  2017-09-28 16:30:00 */
...
{
    setcookie($key, $value, $expire, $cookie_path, $cookie_domain, NULL, TRUE);
}
